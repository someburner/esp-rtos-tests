...
def main():
    ...
    parser.add_argument(
        '--path', '-ps',
        help='xtensa bintools path',
        default='/home/jeffrey/esp-open-sdk-1.5.4.1/xtensa-lx106-elf/bin')
    ...
    # parser_make_image.add_argument('--path', '-ps', action='append', help='xtensa bintools path', default='/home/jeffrey/esp-open-sdk-1.5.4.1/xtensa-lx106-elf/bin')
